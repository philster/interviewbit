...
module.exports = { 
    ...
    preorderTraversal : function(A){
        ...
        result = [].concat(A.data, module.exports.preorderTraversal(A.left), module.exports.preorderTraversal(A.right));
        */

        // solution 2 (use stack) -- time limit exceeded?
        if (A === null) {
            return [];
        }
        ...
        /*
        // solution 3 (no need of stack, but requires modifying the tree) -- time limit exceeded?
        var curr = A;
        while (curr !== null) {
...
// console.log('Output : [' + module.exports.preorderTraversal(root).join(', ') + ']');
